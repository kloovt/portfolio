      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed">
            ...
            <br></br><br></br>
            I'm not quite sure what other information you might be interested in, but just in case: I'm right-handed, I have visited every Dutch province, I wear size 45 (EU) shoes, my favourite planet is Saturn, I have a 100% win rate in Smash Bros, I was born 1 week prematurely, I prefer manual transmission to automatics, I wear a silver ring and necklace, my legal first name has 8 syllables, I still have all my wisdom teeth, my car is exactly 208 days older than me, adding the housenumbers I've lived at together makes 110, I'm blood type A+, my first girlfriend later emigrated to Australia, I have driven 3 laps around the Nürburgring, my favourite film is Scott Pilgrim vs. the World, I can read Cyrillic, I have never broken a bone, my most visible scar is from fighting a Slovenian turnstile, I won a gold medal in a skiing competition when I was 6 years old, I've read every book in the Harry Potter Series and didn't enjoy a single one, I can recite the first 32 digits of Pi, I once ranked as top listener of a small Texan band on Spotify, my parents would've named me Rhodee if I'd been born female, my personal record for number of steps taken in a single week is 156.5k, my favourite Pokémon is Ampharos, I have a trailer license, my spiciness tolerance has been described as 'exceedingly Dutch', and I have been hit by a car twice. 
            <br></br><br></br>
