      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 py-10 leading-relaxed">
            ...
            Node-RED dashboard that also allowed data collection.
            <br></br>
            <br></br>
            ...
            Rovaniemi and Vienna. We traveled to Rovaniemi in mid-February,
            except for me, because I'd caught Covid in the week leading up to
            the trip. Fortunately my quarantine ended in time for me to safely
            join for the latter half of the trip. Rovaniemi is in spitting
            distance of the polar circle and it's noticeable; at one point the
            temperature on the rental Toyota Yaris read -20°C. Despite the
            weather and the untimely illness I had a great time. Rovaniemi is a
            fascinating place to be. It's a defiant island of comfortable
            ...
            and a panel of industrys specialists. I loved my time in Vienna. It
            ...
            classical concert in St Peter's Church, and many more. I got carried
            away with seeing everything the city had to offer and reached my
            personal record for number of steps walked in a week (156.5k).
          </p>
        </div>
