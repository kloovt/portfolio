      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 py-10 leading-relaxed">
            This is the most recent of my portfolio projects, and I think it
            ...
            new things quickly.
            <br></br>
            <br></br>I started making this portfolio about 2 weeks ago and have
            spent perhaps 15 hours on it so far. I know it's not the most
            ...
            about. It's been {">"}3 years since I last had to use html and I had no
            React.js experience whatsoever. As an embedded-systems guy I have no
            direct reason to learn any of this.
            <br></br>
            <br></br>
            I'm so inexperienced with this are that, at the time of writing, I
            don't know how I'm going to take this from a locally running node
            application to a publically accessible webpage. If you're reading
